...
if(inventory == true){
	...
	for(var i = 0;i < totalSlots;i++){
		...
		if(gridItems[# Infos.Item,i] == 0) && key == true{
			...
			draw_text_ext_transformed(xSlot + sizeSlots-10,ySlot + sizeSlots-10,gridItems[# Infos.Quantidade,i],0,100,2,2,0)
			
		}else if(gridItems[# Infos.Item,i] == 1 && coins == true ){
